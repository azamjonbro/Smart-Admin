<template>
    <div class="navbar d-flex column j-between p-24">
        <div class="navbar-logo">
            <svg width="220" height="40" viewBox="0 0 487 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="navbar-menu d-flex column gap24">
            <li :class="activePage === 'home' ? 'active' : 'left-item'" @click="setActive('home')">Home</li>
            <li :class="activePage === 'product' ? 'active' : 'left-item'" @click="setActive('product')">Продукты</li>
            <li :class="activePage === 'client' ? 'active' : 'left-item'" @click="setActive('client')">Фирма</li>
            <li :class="activePage === 'warehouse' ? 'active' : 'left-item'" @click="setActive('warehouse')">Склад</li>
            <li :class="activePage === 'users' ? 'active' : 'left-item'" @click="setActive('users')">Специалист</li>
            <!-- <li :class="activePage === 'leads' ? 'active' : 'left-item'" @click="setActive('leads')">Лиды</li> -->
            <li :class="activePage === 'vozvrat' ? 'active' : 'left-item'" @click="setActive('vozvrat')">Возврат</li>
            <li :class="activePage === 'archive' ? 'active' : 'left-item'" @click="setActive('archive')">Архив</li>
        </div>
        <div class="navbar-buttonbox">
            <button @click="exitLogin">Exit</button>
        </div>
    </div>
</template>
...
.navbar-buttonbox>button:active {
